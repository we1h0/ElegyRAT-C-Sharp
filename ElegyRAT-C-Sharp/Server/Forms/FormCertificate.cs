                ...
                await Task.Run(() =>
                {
                    try
                    {
                        ...
                        Program.form1.listView1.BeginInvoke((MethodInvoker)(() =>
                        {
                            ...
                            MessageBox.Show(this, @"
[!] 如果要升级到ElegyRAT的新版本,则需要复制 'ServerCertificate.p12'.
[!] 如果丢失/删除“ServerCertificate.p12”证书,则无法控制客户端,将丢失所有客户端.", "证书", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            this.Close();
                        }));
                    }
                    catch (Exception ex)
                    {
                        ...
                        {
                            //MessageBox.Show(this, ex.Message, "Certificate", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            MessageBox.Show(this, ex.Message, "证书", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            button1.Text = "OK";
